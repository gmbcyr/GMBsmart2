 ...
 */
class MyDeviceBeanAdapter(private val query: Query,
                          private val mListener: OnItemSelectListener,
                          private val mTwoPane: Boolean,
                          private val viewRoot:View,
                          private val activity: AppCompatActivity) :
        MyFBadapter<MyDeviceBeanAdapter.ViewHolder>(query),MyAdapterUpdate {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view= ViewHolder(inflater.inflate(R.layout.fragment_device, parent, false),parent.context,this)
    ...
    class ViewHolder(itemView: View,private val context: Context,private val myAdapter: MyAdapterUpdate)//ButterKnife.bind(this, itemView);
        ...
        fun bind(snapshot: DocumentSnapshot?,
            ...
            var item: MyDeviceBean = snapshot!!.toObject(MyDeviceBean::class.java)!!
            //Resources resources = itemView.getResources();

            itemView.content.setText(item.getName())
            itemView.txtDetails1.setText(item.devId)
            itemView.txtDetails2.setText(item.location)
            ...
            itemView.setOnClickListener {
                if (listener != null) {
                    listener!!.onItemSelected(item,twoPane)
                }
            }
